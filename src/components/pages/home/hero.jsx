      ...
      <div className="container mx-auto flex max-w-[1000px] flex-col-reverse items-center py-16 md:flex-row">
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <button
            ...
            onClick={componentData.ctaButton.onClick}
          >
        ...
        <div className="w-full md:w-1/2">
          {componentData.heroMedia.type === "image" && (
            <img
              src={componentData.heroMedia.src}
              alt={componentData.heroMedia.alt}
